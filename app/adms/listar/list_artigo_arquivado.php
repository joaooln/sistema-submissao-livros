    ...
    <div class="d-flex">
        ...
        <div class="content p-1">
            <div class="list-group-item">
                ...
                $resul_artigo = "SELECT artigo.id, artigo.tituloArtigo, artigo.tituloLivro, artigo.arquivo, artigo.adms_livro_id, sitartigo.nome nome_sitartigo, cors.cor cor_cors, artigo.adms_tp_subms_id,artigo.adms_sit_artigo_id, livro.nome nome_livro,
