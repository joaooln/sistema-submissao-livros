            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle menu-header" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown">
                    ...
                    if (!empty($row_user_hd['imagem'])) {
                        echo "<img class='rounded-circle' src='" . pg . "/assets/imagens/usuario/" . $row_user_hd['id'] . "/" . $row_user_hd['imagem'] . "' width='30' height='30'>";
                    } else {
                        echo "<img class='rounded-circle' src='" . pg . "/assets/imagens/usuario/icone_usuario.png' width='30' height='30'>";
                    }
                    ?> 
                    &nbsp;
